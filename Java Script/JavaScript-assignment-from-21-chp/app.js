...
// function greet() {
//     var first1 = prompt("write your first name ?");
//     var last1 = prompt("write your last name ?");
//     console.log("Hello " + first1 + " " + last1)
// }
...
// function innum1() {
//     var innum2 = prompt("write a number")
//     var innum3 = prompt("write the second number")
//     console.log(innum2 - innum3)
// }
// innum1();

//question-4

function calculatee(num1, operater, num2,) {
    if (operater === "-") {
...
//question-7
// function counting() {
//     var first3 = Number(prompt("give a start number"))
//     var first4 = Number(prompt("give the last number"))

//     for (let i = first3; i <= first4; i++) {
//         console.log(i)
//     }
// }
...
function rectangle(width, height) {
    console.log(width * height + " The area of rectangle")
}
rectangle(40, 30);

//question-10
function isPalindrome(str) {
    var join= str.split(" ").reverse().join(" ")
    if (str=== join){
...
//question-11
function cap(letter1, letter2, letter3) {
    let result2= letter1[0].toUpperCase() + letter1.slice(1) + " " +
                 letter2[0].toUpperCase() + letter2.slice(1) + " " +
                 letter3[0].toUpperCase() + letter3.slice(1);
    console.log(result2);
}

cap("web", "dev", "mobile"); // Web Dev Mobile
...
countLetter("JSResourceS.com", "o"); // 2